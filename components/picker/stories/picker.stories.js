...
const ChromaticPickerGroup = (args) => {
	const sectionData = [
		...
		{
			sectionName: "Quiet + error",
			componentMarkup: States({
				...args,
				isQuiet: true,
				isInvalid: true,
				fieldLabelPrefix: "picker-quiet-error",
			}),
		},
		{
		...
		{
			sectionName: "Side label: Error",
			componentMarkup: States({
				...args,
				isInvalid: true,
				labelPosition: "side",
				fieldLabelPrefix: "picker-side-label-error",
			}),
		},
		{
		...
		{
			sectionName: "Side label: quiet + error",
			componentMarkup: States({
				...args,
				isQuiet: true,
				isInvalid: true,
				labelPosition: "side",
				fieldLabelPrefix: "picker-side-label-quiet-error",
			})
		},
		{
